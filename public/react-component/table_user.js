...
function Table() {
  ...
  React.useEffect(() => {
    axios.get('/api/user_application')
      .then(response => {
          ...
          <table class="table align-items-center mb-0">
            <thead>
              <tr>
                ...
                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Đã ứng tuyển</th>
              ...
              {userinpage.map((userinpage) =>
                <tr>
                  ...
                  <td class="align-middle text-center">
                    <a type="button" class="text-info font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">xem tin<br/>{userinpage.applications_count}</a>
                  </td>
                  <td class="align-middle text-center">
                    <span class="text-secondary text-xs font-weight-bold">{new Date(userinpage.created_at).toString()}</span>
                  </td>
                  <td class="align-middle">
                        <a type="button" class="text-danger font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">Gỡ</a>
                  </td>
                </tr>
              )}
            </tbody>
